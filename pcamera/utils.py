...
class Image():
    ...
    def plotImageWithBox(self):
        ...
        for i in self.boxPoints:
            ...
            rect = patches.Rectangle((x,y),_boxpoints[2]*_length,_boxpoints[3]*_width,linewidth=1,edgecolor=color,facecolor='none')
            ax.add_patch(rect)
        plt.show()
        print(count)
        pass
...
path = 'Cone Detection/yolo_cones/data/dataset/in5_0001'
image = Image(path)
print('Done')